  ...
  SECTION("Narrow strings") {
    ...
    const auto testParams = GENERATE(
        TestParams<char>{"Split to string view on space",
                         ...
                         {"One", "small", "step", "for", "man..."}},
        TestParams<char>{
            "Split string on non-space", "1,2,3,4,5", ',', string::split_behaviour::drop_empty, {"1", "2", "3", "4", "5"}},
        ...
        TestParams<char>{"Split string on space, dropping empty items",
                         ...
                         {"1", "2", "3", "4", "5"}},
        TestParams<char>{
            "Split string without any delimiters in it", "1 2 3 4 5", ',', string::split_behaviour::drop_empty, {"1 2 3 4 5"}},
    ...
    SECTION(testParams.name) {
      SECTION("To strings") {
        const auto words =
            string::split_to<std::vector<std::string>>(testParams.toSplit, testParams.delimiter, testParams.behaviour);
      ...
      SECTION("To string_views") {
        const auto words =
            string::split_to<std::vector<std::string_view>>(testParams.toSplit, testParams.delimiter, testParams.behaviour);
  ...
  SECTION("Wide strings") {
    ...
    const auto testParams = GENERATE(
        TestParams<wchar_t>{"Split to string view on space",
                            L"One small step for man...",
                            L' ',
                            string::split_behaviour::drop_empty,
                            {L"One", L"small", L"step", L"for", L"man..."}},
        TestParams<wchar_t>{
            "Split string on non-space", L"1,2,3,4,5", L',', string::split_behaviour::drop_empty, {L"1", L"2", L"3", L"4", L"5"}},
        TestParams<wchar_t>{"Split string on space, keeping empty items",
                            L"1,2,,3,4,5",
                            L',',
                            string::split_behaviour::keep_empty,
                            {L"1", L"2", L"", L"3", L"4", L"5"}},
        TestParams<wchar_t>{"Split string on space, dropping empty items",
                            ...
                            {L"1", L"2", L"3", L"4", L"5"}},
        TestParams<wchar_t>{
            "Split string without any delimiters in it", L"1 2 3 4 5", L',', string::split_behaviour::drop_empty, {L"1 2 3 4 5"}},
    ...
    SECTION(testParams.name) {
      SECTION("To strings") {
        const auto words =
            string::split_to<std::vector<std::wstring>>(testParams.toSplit, testParams.delimiter, testParams.behaviour);
      ...
      SECTION("To string_views") {
        const auto words =
            string::split_to<std::vector<std::wstring_view>>(testParams.toSplit, testParams.delimiter, testParams.behaviour);
