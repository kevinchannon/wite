...
struct bounds {
  ...
  _WITE_NODISCARD constexpr bool operator<(const bounds& other) const noexcept { return max < other.min; }
  _WITE_NODISCARD constexpr bool operator>(const bounds& other) const noexcept { return min > other.max; }
